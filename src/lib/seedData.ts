...
const xl: SeedTask[] = [
  ...
  // ── Backlog (25) ──
  { name: 'Set up rich text collaborative editing', size: 'S', priority: 'Low', completed: false },
  { name: 'Document DB schema conventions', size: 'S-M', priority: 'Low', completed: false },
  { name: 'Explore keyboard-driven navigation', size: 'M', priority: 'Low', completed: false, rolledOver: true },
  { name: 'Prototype dashboard drag-and-drop', size: 'M-L', priority: 'Low', completed: false },
  { name: 'Evaluate role-based access framework', size: 'L', priority: 'Low', completed: false },
  { name: 'Spike: team management redesign', size: 'S', priority: 'Low', completed: true },
  { name: 'Research session replay tooling', size: 'S-M', priority: 'Low', completed: true },
  { name: 'Benchmark CSV import performance', size: 'M', priority: 'Low', completed: true },
  { name: 'Explore S3 to R2 migration', size: 'M-L', priority: 'Low', completed: false },
  { name: 'Prototype real-time login alerts', size: 'L', priority: 'Low', completed: false },
  { name: 'Spike: email drag builder', size: 'S', priority: 'Low', completed: false },
  { name: 'Research webhook observability', size: 'S-M', priority: 'Low', completed: false },
  { name: 'Explore activity feed ML ranking', size: 'M', priority: 'Low', completed: false, rolledOver: true },
  { name: 'Prototype API GraphQL layer', size: 'M-L', priority: 'Low', completed: false },
  { name: 'Evaluate PDF generation libraries', size: 'L', priority: 'Low', completed: false },
  { name: 'Spike: Redis pub/sub for live updates', size: 'S', priority: 'Low', completed: true },
  { name: 'Research accessibility automation', size: 'S-M', priority: 'Low', completed: true },
  { name: 'Benchmark billing calculation engine', size: 'M', priority: 'Low', completed: true },
  { name: 'Explore analytics event streaming', size: 'M-L', priority: 'Low', completed: false },
  { name: 'Prototype data export templates', size: 'L', priority: 'Low', completed: false },
  { name: 'Spike: image AI auto-tagging', size: 'S', priority: 'Low', completed: false },
  { name: 'Research rich text block protocol', size: 'S-M', priority: 'Low', completed: false },
  { name: 'Explore DB read replicas', size: 'M', priority: 'Low', completed: false, rolledOver: true },
  { name: 'Prototype shortcut command palette', size: 'M-L', priority: 'Low', completed: false },
  { name: 'Evaluate dashboard charting libraries', size: 'L', priority: 'Low', completed: false },
];
